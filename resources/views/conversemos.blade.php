			...
			<div class="shell">
				...
				<div class="offset-top-30 text-center">
					<p>
						...
						{{-- <b><p class="offs offset-top-30" style="text-align: justify; font-style: oblique;">
						No dude en ponerse en contacto conmigo día y noche.
						Respondo todos los correos electrónicos en no más 
						de dos días hábiles. Si su idea no lo deja dormir, 
						envieme un correo a traves del formulario o en 
						forma directa, adjunte su numero telefonico y lo 
						llamaré a la brevedad posible.
					</p></b> --}}
			...
			<section class="context-dark">
				<div class="rd-parallax" data-on="false" data-md-on="true">
					...
					<div class="rd-parallax-layer" data-speed="0" data-type="html">
						<div class="shell section-98 section-sm-85 section-lg-bottom-20">
							<h1>Cont&aacute;ctame</h1>
							<hr class="divider bg-mantis" style="background: #ff7e00">
								<div id="mail-status" name='mail-status' class="range range-sm-center">

								</div>
								{{-- <div class='alert alert-dismissible alert-success message-mail-success' role='alert' >
									<button class='close' type='button' data-dismiss='alert' aria-label='Close'>
										<span class='mdi mdi-close' aria-hidden='true'></span>
									</button>
									<p class='offset-top-0 text-success-mail'>
